                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h3 class="header smaller lighter blue">
                                <%--<spring:message code="user.title.${cmd}"/>--%>新增班级
                            ...
                            <form action="grade/grade/save_${cmd}.do" method="post" class="form-horizontal"
                                  role="form"
                                  id="admin-add-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" autocomplete="off" id="name" name="name"
                                         value="${grade.name}"      class="required form-control"/>
                                    </div>
                                </div>
