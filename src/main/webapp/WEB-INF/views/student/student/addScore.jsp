                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h3 class="header smaller lighter blue">
                                <%--<spring:message code="user.title.${cmd}"/>--%>录入分数
                            ...
                            <form action="student/student/save_${cmd}.do" method="post" class="form-horizontal"
                                ...
                                <div class="form-group">
                                    <c:forEach items="${stuSubs}" var="stuSub">
                                        <input type="hidden" value="${stuSub.subject.id}" name="subject.id">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" autocomplete="off" id="name" name="score"
                                                       value="${stuSub.score}"      class="required form-control"/>
                                            </div>
                                        </div>
